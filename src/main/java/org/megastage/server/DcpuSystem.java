...
public class DcpuSystem extends ECSEntitySystem {
    ...
    protected void processEntity(ECSEntity eid) throws ECSException {
        ...
        public void tickHardware(CompDCPU dcpu) {
        ...
        public void tick(CompDCPU dcpu) {
            dcpu.ticks++;
            if (dcpu.isOnFire) {
...
//          break;
        ...
        public int getAddrB(CompDCPU dcpu, int type) {
            switch (type & 0xF8) {
                case 0x00:
        ...
        public int getAddrA(CompDCPU dcpu, int type) {
            if (type >= 0x20) {
        ...
        public char getValA(CompDCPU dcpu, int type) {
            if (type >= 0x20) {
        ...
        public char get(CompDCPU dcpu, int addr) {
            if (addr < 0x10000)
        ...
        public void set(CompDCPU dcpu, int addr, char val) {
            if (addr < 0x10000)
